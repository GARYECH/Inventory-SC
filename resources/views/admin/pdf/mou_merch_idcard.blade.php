...
>
    ...
    merchandise berupa ID Card melalui
...
<div class="isi-pasal">
    ...
    <ol>
        ...
        <li>
            ...
            <strong>PIHAK KEDUA</strong> berupa ID Card sesuai
            dengan jumlah sebagaimana tercantum dalam Pasal I.
...
<div class="isi-pasal">
    ...
    <ol>
        ...
        <li>
            Memberikan data, jumlah, dan desain yang benar
        ...
        <li>
            Melakukan pemeriksaan terhadap ID Card setelah
            menerima barang.
        </li>
