                    ...
                    <div class="lg:col-span-7 space-y-6">
                        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden relative">
                            <div class="p-8 bg-gray-50/50 border-b border-gray-100 flex justify-between items-center relative overflow-hidden">
                                <div class="relative z-10">
                                    ...
                                    <span class="inline-flex px-3 py-1 text-[9px] font-black uppercase tracking-widest rounded-lg
                                        ...
                                        {{ $orderType === 'Obat' ? 'bg-amber-100 text-amber-700' : '' }}
                            ...
                            <div class="p-6 space-y-5">
                                @foreach($cart as $id => $details)
                                    @php
                                        ...
                                        $hasReturnSchedule = !empty($details['end_date']) && !empty($details['end_time']);
                                    @endphp
                                        ...
                                        <div class="flex items-start gap-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex justify-between items-start">
                                                    <h4 class="font-black text-gray-900 text-base sm:text-lg leading-tight truncate pr-4">
                                                        {{ $details['name'] }}
                                                    </h4>
                                                ...
                                                @if(!empty($details['start_date']) && !empty($details['start_time']))
                                                    <div class="mt-2 flex flex-col gap-2">
                                                        <div class="inline-flex items-center gap-2 px-3 py-2 bg-indigo-50 border border-indigo-100 rounded-xl text-[10px] font-bold text-indigo-700 uppercase tracking-widest w-fit">
                                                            ...
                                                            <span>
                                                                Transaksi:
                                                                {{ \Carbon\Carbon::parse($details['start_date'])->format('d M Y') }}
                                                                ·
                                                                {{ $details['start_time'] }}
                                                            </span>
                                                        </div>
                                                        ...
                                                        @if($hasReturnSchedule)
                                                            <div class="inline-flex items-center gap-2 px-3 py-2 bg-amber-50 border border-amber-100 rounded-xl text-[10px] font-bold text-amber-700 uppercase tracking-widest w-fit">
                                                                <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9M20 20v-5h-.581m-15.357-2a8.001 8.001 0 01-15.356-2"></path>
                                                                </svg>

                                                                <span>
                                                                    Pengembalian:
                                                                    {{ \Carbon\Carbon::parse($details['end_date'])->format('d M Y') }}
                                                                    ·
                                                                    {{ $details['end_time'] }}
                                                                </span>
                                                            </div>
                                                ...
                                                @if(!empty($details['subcategory']))
                                                    <div class="mt-2">
                                                        <span class="inline-flex px-2.5 py-1 bg-gray-100 text-gray-600 text-[9px] font-black rounded-lg uppercase tracking-widest">
                                                            {{ $details['subcategory'] }}
                                                        </span>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="flex items-center gap-2 mt-2 flex-wrap">
                                                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                                        Harga: Rp {{ number_format($details['price'], 0, ',', '.') }}
                                                    </p>
                                        ...
                                        <div class="flex flex-row items-center justify-between border-t border-gray-100 pt-4 mt-1">
                                            <form action="{{ route('student.cart.update', $id) }}" method="POST" class="flex items-center bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm h-10">
                                                ...
                                                <input
                                                    ...
                                                    min="1"
                                                    required
                                                    class="w-16 h-full bg-transparent border-none text-center text-sm font-black text-gray-900 focus:ring-0 px-2"
                                                >
                                            ...
                                            <div class="text-right">
                                                ...
                                                <p class="font-black text-indigo-600 text-lg sm:text-xl leading-none">
                            ...
                            <div class="p-8 bg-gray-900 flex justify-between items-center rounded-b-[2.5rem]">
                                <div>
                                    <span class="font-black text-gray-400 uppercase tracking-[0.2em] text-[11px] block">
                                        Grand Total Normal
                                    </span>

                                    <span class="text-[9px] text-indigo-300 font-bold">
                                        *Otomatis Rp 0 di sistem jika Anda pilih Student Council
                                    </span>
                                </div>
                            ...
                            <form action="{{ route('student.cart.checkout') }}" method="POST" class="space-y-5">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            name="position"
                                            placeholder="e.g. Koordinator Inventory"
                                            required
                                            class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-gray-800 placeholder-gray-300 transition-all shadow-inner text-sm"
                                        >
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            name="proker_name"
                                            placeholder="e.g. Rector Cup 2026"
                                            required
                                            class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-gray-800 placeholder-gray-300 transition-all shadow-inner text-sm"
                                        >
                                    </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="address"
                                        rows="2"
                                        placeholder="e.g. Jl. Citraland CBD..."
                                        required
                                        class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-gray-800 placeholder-gray-300 transition-all shadow-inner text-sm"
                                    ></textarea>
                                </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea
                                        name="notes"
                                        rows="3"
                                        placeholder="Contoh: Min, tolong dipastikan barang aman ya..."
                                        class="w-full px-5 py-4 bg-yellow-50/50 border border-yellow-100 rounded-2xl focus:ring-2 focus:ring-yellow-400 font-bold text-gray-800 placeholder-gray-400 transition-all shadow-inner text-sm"
                                    ></textarea>
                                </div>
                                ...
                                <div class="mt-6 p-5 bg-indigo-50 border border-indigo-100 rounded-2xl flex items-center gap-4 shadow-sm">
                                    ...
                                    <div>
                                        <p class="text-xs font-black text-indigo-900 uppercase tracking-widest">
                                            Jadwal Transaksi
                                        </p>

                                        <p class="text-[10px] font-bold text-indigo-600 mt-1 leading-snug">
                                            Setiap transaksi memiliki tanggal dan jam yang sudah dipilih sebelumnya. Jam transaksi hanya tersedia antara 17:00 sampai 19:00.
                                        </p>
                                    </div>
                                </div>

                                @if($isConsumable)
                                    <div class="p-5 bg-amber-50 border border-amber-100 rounded-2xl flex items-center gap-4 shadow-sm">
                                        ...
                                        <div>
                                            <p class="text-xs font-black text-amber-900 uppercase tracking-widest">
                                                Tidak Ada Pengembalian
                                            </p>

                                            <p class="text-[10px] font-bold text-amber-600 mt-1 leading-snug">
                                                {{ $orderType }} merupakan transaksi sekali pakai dan tidak memerlukan jadwal pengembalian. Stok akan dipotong sesuai ketentuan sistem.
                                            </p>
                                        </div>
                                    </div>
                                @else
                                    <div class="p-5 bg-indigo-50 border border-indigo-100 rounded-2xl flex items-center gap-4 shadow-sm">
                                        <div class="w-10 h-10 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center shrink-0">
                                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9M20 20v-5h-.581m-15.357-2a8.001 8.001 0 00-15.356 2"></path>
                                            </svg>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[10px] font-bold text-indigo-600 mt-1 leading-snug">
                                                Tanggal dan jam pengembalian wajib dipilih untuk transaksi peminjaman. Jam pengembalian hanya tersedia antara 17:00 sampai 19:00.
                                            </p>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="bg-red-50/80 p-6 border-b border-red-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                                        <div class="flex items-center gap-4 w-full sm:w-auto">
                                            <div class="w-12 h-12 bg-red-100 text-red-600 rounded-full flex items-center justify-center shrink-0">
                                                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c.98 0 1.54-1.06 1.05-1.91L13.05 4.91c-.47-.82-1.63-.82-2.1 0L3.89 16.09c-.49.85.07 1.91 1.05 1.91z"></path>
                                                </svg>
                                            </div>

                                            <div>
                                                <h4 class="font-black text-red-900 text-sm uppercase tracking-widest">
                                                    Wajib Baca SOP
                                                </h4>

                                                <p class="text-[10px] text-red-600 font-bold mt-1">
                                        ...
                                        @if($sopPath)
                                            <a
                                                ...
                                                target="_blank"
                                                class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-3.5 bg-red-600 text-white font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-red-700 hover:shadow-lg hover:shadow-red-300 transition-all active:scale-95 shrink-0"
                                            >
                                    ...
                                    <label class="flex items-start p-6 cursor-pointer hover:bg-gray-50 transition-colors">
                                        <div class="flex-shrink-0 mt-1">
                                            <input
                                                ...
                                                value="1"
                                                required
                                                class="w-6 h-6 text-red-600 border-gray-300 rounded-md shadow-inner focus:ring-red-500 cursor-pointer transition-all"
                                            >
                                        </div>

                                        <div class="ml-4">
                                            <span class="block text-sm font-black text-gray-900 uppercase tracking-widest">
                                ...
                                <button
                                    type="submit"
                                    class="w-full py-5 bg-gray-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:bg-indigo-600 transition-all shadow-xl shadow-gray-200 active:scale-95 flex justify-center items-center group"
                                >
                                    Submit Order Request

                                    <svg class="w-4 h-4 ml-3 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24">
