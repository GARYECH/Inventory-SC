...
<body class="bg-[#13113C] min-h-screen flex items-center justify-center py-12 px-6 relative overflow-x-hidden selection:bg-[#E5A87B] selection:text-[#13113C]">
    ...
    <div class="relative w-full max-w-lg z-10">
        ...
        <div class="relative bg-[#F6F3E7] border-2 border-dashed border-[#E5A87B] p-10 sm:p-14 rounded-2xl shadow-xl">
            ...
            <!-- 🌟 TOMBOL GOOGLE REGISTER DI ATAS 🌟 -->
            <div class="mb-6">
                <a href="{{ route('google.login') }}" class="w-full flex items-center justify-center gap-3 bg-white border-2 border-[#13113C]/10 text-[#13113C] px-4 py-4 font-bold text-sm hover:border-[#E5A87B] hover:text-[#E5A87B] transition-all duration-300">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-5">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required class="w-full px-5 py-4 bg-white border-2 border-[#13113C]/10 rounded-none text-[#13113C] font-medium focus:ring-0 focus:border-[#E5A87B] outline-none transition-all placeholder:text-gray-400" placeholder="johndoe@gmail.com">
            ...
            <p class="mt-8 text-center text-[#13113C]/70 font-medium">
                Already registered? <a href="{{ route('login') }}" class="text-[#E5A87B] font-bold hover:text-[#13113C] transition-colors underline decoration-2 underline-offset-4">Log in</a>
            </p>
