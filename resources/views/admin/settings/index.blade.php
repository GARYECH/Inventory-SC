<x-app-layout>
                ...
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mt-1.5">
                            Guidebook & General Configuration
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-xs font-black text-indigo-900">
                                        Guidebook Ter-Upload
                                    </p>

                                    <p class="text-[9px] text-indigo-600">
                                        Mahasiswa dapat mengakses file ini melalui menu Guidebook.
                                    </p>
                                </div>
                            </div>
    ...
    <script>
        // Guidebook file name
        const guidebookInput = document.getElementById('guidebook_input');
        const guidebookFilename = document.getElementById('guidebook_filename');

        if (guidebookInput) {
            guidebookInput.addEventListener('change', function (event) {
                if (event.target.files.length > 0) {
                    guidebookFilename.innerText =
                        "File Dipilih: " + event.target.files[0].name;

                    guidebookFilename.classList.add('text-indigo-600');
                }
            });
        }
