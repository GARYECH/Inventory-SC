...
@php
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | HANYA Merchandise / ID Card yang benar-benar
    | terdapat dalam order ini.
    |
    */
...
<div class="page">
    ...
    <p class="paragraph">
        ...
        (MoU) tentang pembelian ID Card+Lanyard untuk kegiatan
...
<div class="page">
    ...
    <p class="paragraph">
        ...
        berupa ID Card+Lanyard sesuai dengan kebutuhan
            ...
            @else
                ...
                <tr>
                    ...
                    <td
                        ...
                        style="height:18mm;"
                    >
                        Tidak ada ID Card yang dipesan.
                    </td>
...
<div class="page">
    ...
    <p class="paragraph">
        ...
        Adapun spesifikasi ID Card tersebut adalah sebagai berikut.
            ...
            <td class="spec-value">
                ...
                @else
                    ...
                    <span class="dynamic empty">
                        (Insert mockup design per kebutuhan + link element/asset)
                    </span>
    ...
    <ol class="legal-list">
        ...
        <li>
            <strong>PIHAK PERTAMA</strong>
            berhak menerima dokumen kuitansi yang telah ditandatangani
            oleh <strong>PIHAK KEDUA</strong>
            melalui website Inventory Student Council sebagai bukti
            sah penyelesaian administrasi keuangan apabila pesanan
            berada pada status “<em>Waiting for Kwitansi</em>”.
        </li>
        ...
        <li>
            ...
            <strong>PIHAK KEDUA</strong>
            melalui website Inventory Student Council yang memuat
            dokumentasi barang yang diajukan untuk retur.
...
<div class="page">
    ...
    <div class="paragraph">
        ...
        diajukan untuk retur. Dokumentasi wajib disertai foto yang
        menunjukkan kondisi cacat atau rusak pada barang serta diberi
        nama dengan format “Nama Barang - Ukuran - Divisi”.
...
<div class="page">
    ...
    <ol class="legal-list">
        ...
        <li>
            ...
            cacat, error, atau rusak saat serah terima dan
        ...
        <li>
            <strong>PIHAK PERTAMA</strong>
            berkewajiban menerima pengajuan pengembalian barang cacat
            (<em>retur</em>) dari <strong>PIHAK KEDUA</strong>
            selambat-lambatnya 3 (tiga) hari kerja setelah barang
            diterima. Klasifikasi cacat meliputi:

            <div class="mt-small">

                - ID Card: Casing pelindung pecah atau retak,
                hasil cetak buram atau berbayang, warna cetak
                melenceng dari sample, terdapat kesalahan ketik nama
                atau divisi yang tidak sesuai dengan data master,
                potongan kartu tidak presisi, serta kerusakan atau
                kecacatan lain yang mengakibatkan ID Card tidak dapat
                digunakan sebagaimana mestinya.

                <br>

                - Lanyard: Tali lanyard rantas atau terpotong,
                hasil cetak desain tidak sesuai dengan sample,
                warna cetak melenceng dari sample, serta besi
                pengait (hook) lanyard rusak, macet, atau tidak dapat
                digunakan sebagaimana mestinya.
...
<div class="page">
    ...
    <ol class="legal-list">
        ...
        <li>
            <strong>PIHAK KEDUA</strong>
            berhak menerima barang dalam kondisi baik, layak pakai,
            berfungsi dengan baik, dan sesuai spesifikasi serta
            jumlah sebagaimana tercantum dalam <strong>Pasal I.</strong>
        </li>
        ...
        <li>
            ...
            <strong>PIHAK PERTAMA</strong>, apabila ditemukan barang
            yang cacat, error, atau rusak pada saat serah terima dan
            <em>quality control</em>. Setelah proses
            <em>quality control</em> selesai,
        ...
        <li>
            ...
            - ID Card: Casing pelindung pecah atau retak, hasil
            cetak buram atau berbayang, warna cetak melenceng dari
            sample, terdapat kesalahan ketik nama atau divisi yang
            tidak sesuai dengan data master, potongan kartu tidak
            presisi, serta kerusakan atau kecacatan lain yang
            mengakibatkan ID Card tidak dapat digunakan sebagaimana
            mestinya.

            <br>

            - Lanyard: Tali lanyard rantas atau terpotong, hasil
            cetak desain tidak sesuai dengan sample, warna cetak
            melenceng dari sample, serta besi pengait (hook) lanyard
            rusak, macet, atau tidak dapat digunakan sebagaimana
            mestinya.
...
<div class="page">
    ...
    >
        ...
        <li>
            <strong>PIHAK KEDUA</strong>
            berhak menerima penyelesaian barang retur atau barang
            pengganti dari <strong>PIHAK PERTAMA</strong> dalam waktu
            pengerjaan paling lambat 5 (lima) hari kerja sejak barang
            cacat diserahkan kembali.
        </li>
...
<div class="page">
    ...
    <ol class="legal-list">
        ...
        <li>
            ...
            <strong>PIHAK PERTAMA</strong> yang memuat kelengkapan
            spesifikasi berupa file desain elemen/logo beresolusi
            tinggi format PNG, referensi penempatan desain pada baju
            (<em>mock-up</em>), serta panduan detail ukuran
            selambat-lambatnya 21 (dua puluh satu) hari kerja sebelum
        ...
        <li>
            <strong>PIHAK KEDUA</strong>
            wajib mengajukan klaim retur paling lambat 3 (tiga) hari
            kerja sejak seluruh barang diterima dan menyertakan
            dokumentasi yang menunjukkan kondisi cacat atau rusak
            pada barang serta identitas barang sebagaimana dimaksud
            pada ayat 7.
        </li>
...
<div class="page">
    ...
    <p class="paragraph">
        ...
        proses retur, serta penyelesaian kewajiban lainnya sesuai
